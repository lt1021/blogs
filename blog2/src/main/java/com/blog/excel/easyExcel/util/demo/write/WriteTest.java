...
public class WriteTest {
     ...
     * 模板路径
     */
    private static String path = "E:\\data\\file\\";
    ...
    public void repeatedWrite(){
        ...
        fileName = path+ "repeatedWrite" + System.currentTimeMillis() + "2.xlsx";
        try {
            // 这里 指定文件
            excelWriter = EasyExcel.write(fileName, DemoData.class).build();
        ...
        fileName = path + "repeatedWrite" + System.currentTimeMillis() + "3.xlsx";
        try {
            // 这里 指定文件
    ...
    public void converterWrite() {
        String fileName = path + "converterWrite" + System.currentTimeMillis() + ".xls";
        // 这里 需要指定写用哪个class去写，然后写到第一个sheet，名字为模板 然后文件流会自动关闭
    ...
    public void imageWrite() throws Exception {
        ...
        try {
            ...
            list.add(imageData);
            String imagePath = TestFileUtil.getImage()+"psc.jpg";
            ...
            imageData.setUrl(new URL(
                    "http://tl.w7os.com/thumb/product/45148204-c995-4b59-ac54-a3c4ae89fbfa/HE32146_1.jpg"));
