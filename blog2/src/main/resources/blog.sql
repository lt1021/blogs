...
CREATE TABLE `t_blog` (
  ...
  `apperciation` bit(1) NOT NULL,
  `first_pocture` varchar(255) DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `t_blog_tags` VALUES ('1', '3', '4', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('2', '4', '1', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('3', '4', '3', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('4', '5', '3', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('5', '5', '4', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('6', '7', '2', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('7', '6', '5', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('64', '5', '3', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('65', '4', '3', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('66', '4', '6', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('74', '7', '10', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('75', '8', '11', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('76', '8', '12', '0', '0');
INSERT INTO `t_blog_tags` VALUES ('77', '8', '13', '0', '0');
...
-- ----------------------------
INSERT INTO `t_comment` VALUES ('1', '小白', 'bai@qq.com', '小白的评论', '/images/avatar.jpg', '2020-03-15 21:28:13', '4', '-1', null, null, '\0');
INSERT INTO `t_comment` VALUES ('2', '小红', 'hong@qq.com', '小红的评论', '/images/avatar.jpg', '2020-03-15 21:35:02', '4', '-1', null, null, '\0');
INSERT INTO `t_comment` VALUES ('5', '小蓝', 'lan@qq.com', '小蓝的评论', '/images/avatar.jpg', '2020-03-16 15:04:24', '4', '-1', null, null, '\0');
INSERT INTO `t_comment` VALUES ('7', '朱一鸣', '691639910@qq.com', '博主的评论', 'http://5b0988e595225.cdn.sohucs.com/images/20181103/feaa7d14883047fb81bbaa16f681f583.jpeg', '2020-03-16 15:11:07', '2', '-1', '1', null, '\0');
INSERT INTO `t_comment` VALUES ('8', '安东尼', '2333@qq.com', '不论是我的世界车水马龙繁华盛世 还是它们都瞬间消失化为须臾 我都会坚定地走向你 不慌张 不犹豫', '/images/avatar.jpg', '2020-03-24 17:41:17', '11', '-1', '0', null, '\0');
...
CREATE TABLE `t_comment_reply_comment` (
  `t_comment_id` bigint NOT NULL,
  `reply_comment_id` bigint NOT NULL,
  UNIQUE KEY `UK_tnswom9empncn1dt8pn9b5ain` (`reply_comment_id`),
  KEY `FKa2d17fgkj3p97bk30em288ue6` (`t_comment_id`),
  CONSTRAINT `FK5lcndoa674qo2anwtnb1r4e99` FOREIGN KEY (`reply_comment_id`) REFERENCES `t_comment` (`id`),
  CONSTRAINT `FKa2d17fgkj3p97bk30em288ue6` FOREIGN KEY (`t_comment_id`) REFERENCES `t_comment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
INSERT INTO `t_picture` VALUES ('1', '我的手机', '美女我爱你', '美女秦凌玉', '2020-9-7');
...
INSERT INTO `t_type` VALUES ('7', '刘涛');
INSERT INTO `t_type` VALUES ('17', 'css');
INSERT INTO `t_type` VALUES ('18', 'java');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('1', '刘涛', '刘涛', '985f750f65e391cb0051b1b2e99bc688', '691639910@qq.com', 'https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1584367404804&di=070c78aac95428c480b480a87b534e96&imgtype=0&src=http%3A%2F%2Fbbs.cnlinfo.net%2Fup%2Ftou%2F150611164743.jpg', '1', '2020-03-08 18:25:26', null);
INSERT INTO `t_user` VALUES ('2', '管理员', 'admin', '96e79218965eb72c92a549dd5a330112', 'hh@163.com', 'https://unsplash.it/100/100?image=1005', '1', '2017-10-15 12:36:04', '2017-10-15 12:36:23');
