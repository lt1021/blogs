...
(function() {
  ...
  MT("idShortcut",
     "[attribute&def #EasyPoi] Hey There");

  MT("tagWithIdShortcuts",
     "[tag h1][attribute&def #EasyPoi] Hey There");

  MT("classShortcut",
     "[attribute&qualifier .hello] Hey There");

  MT("tagWithIdAndClassShortcuts",
     "[tag h1][attribute&def #EasyPoi][attribute&qualifier .hello] Hey There");
  ...
  MT("attributes",
     "[tag a]([attribute title]=[string \"EasyPoi\"]) [attribute href]=[string \"link\"]}");

  MT("multiLineAttributes",
     "[tag a]([attribute title]=[string \"EasyPoi\"]",
  ...
  MT("selectorRubyBlock",
     "[tag a][attribute&qualifier .EasyPoi][operator&special =] [variable-2 @item]");

  MT("nestedRubyBlock",
      "[tag a]",
      "  [operator&special =][variable puts] [string \"EasyPoi\"]");
  ...
  MT("interpolationInHashAttribute",
     "[tag div]{[attribute id] = [string \"]#{[variable EasyPoi]}[string _]#{[variable ting]}[string \"]} EasyPoi");

  MT("interpolationInHTMLAttribute",
     "[tag div]([attribute title]=[string \"]#{[variable EasyPoi]}[string _]#{[variable ting]()}[string \"]) Test");
})();
